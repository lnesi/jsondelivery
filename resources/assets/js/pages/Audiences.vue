          ...
          <div class="row">
              <div class="col-md-12 ">
                  <div class="panel panel-default">
                      ...
                      <h2><i class="lnr lnr-tag"></i> Audiences <small><button type="button" class="btn btn-default pull-right" data-toggle="modal" data-target="#addModal"><i class="fa fa-fw fa-plus"></i> Add</button></small></h2>
